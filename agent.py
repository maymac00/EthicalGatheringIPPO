...
class SoftmaxActor(nn.Module):
    ...
    def __init__(self, o_size: int, a_size: int, h_size: int, eval=False):
        super().__init__()

        self.hidden_1 = Linear(o_size, h_size, act_fn='tanh')
        self.hidden_2 = Linear(h_size, h_size, act_fn='tanh')
