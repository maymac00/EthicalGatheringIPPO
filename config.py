...
def parse_args():
    ...
    parser.add_argument("--partial-observability", type=str2bool, default=False, help="Activates partial observability")
    parser.add_argument("--visual-radius", type=int, default=1, help="Radius of partial observability")
    ...
    parser.add_argument("--cuda", type=str2bool, default=True, help="Toggles cuda")  # check .to(device) for GPUs
